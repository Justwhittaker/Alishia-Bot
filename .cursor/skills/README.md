...
Custom Cursor skills for Alishia Bot. Each skill is a folder with `SKILL.md` under `.cursor/skills/` and is available to Cursor Desktop and Cloud Agents when this repo is open.
...
Source: mirrored from Justin Bot’s `.cursor/skills/`.
